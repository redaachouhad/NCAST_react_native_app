import {Image, Text, TextInput, TextInputComponent, TouchableHighlight, View} from 'react-native'
...
const Signin = () => {
    ...
    return (
        <View className={"flex-1 flex-col justify-center gap-15"}>
            ...
            <View className={"w-full p-4 flex-col justify-center items-center"}>
                ...
                >
                    <Text className={"text-4xl text-blue-600 font-bold text-center mb-16"}>Sign In</Text>
                    <TextInput
                        placeholder="Email"
                    ...
                    >
                        <Text className={"text-white text-2xl font-medium text-center py-3"}>Sign in</Text>
                    </TouchableHighlight>
                    ...
                    <Link href={"/signup"} className={"text-center mt-8 text-xl text-blue-500 font-bold"}>
                        New member ?
                    </Link>
                </View>
            </View>
